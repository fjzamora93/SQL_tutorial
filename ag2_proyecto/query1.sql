...
INSERT IGNORE INTO proyectos (idproyecto, nombre, fecha_ini, fecha_fin)
...
INSERT IGNORE INTO departamentos (idpto, nombre, presupuestos)
	VALUES(1, 'I+D', 50000),
		(2, 'Diseño', 25000),
		(3, 'Ventas', 15000),
		(4, 'Marketing', 10000);
...
INSERT IGNORE INTO asignacion (idempleado,idproyecto)
VALUES (10478, 1),
	(10480, 3),
	(10481, 1),
	(10482, 2);
